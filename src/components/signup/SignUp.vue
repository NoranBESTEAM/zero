            ...
            <div class="row d-flex justify-content-center align-items-center">
                ...
                <div
                    ...
                    <form>
                        ...
                        <div class="social d-flex justify-content-center align-items-center mb-4">

                            <a href="https://www.google.com/" class="btn me-4 text-reset">
                                <img src="@/assets/images/signup/Google.svg" alt="">
                            </a>

                            <a href="https://www.facebook.com/" class="btn me-4 text-reset">
                                <img src="@/assets/images/signup/facebook.svg" alt="">
                            </a>

                            <a href="https://www.apple.com/" class="btn me-4 text-reset">
                        ...
                        <router-link :to="{ name: '' }" class="btn mb-4 d-flex justify-content-center align-items-center">
